...
class ScenarioGenerator:
    def __init__(self, weather, road, vehicle, traffic, emergency, time, location, num_scenarios):
...
scenario_generator = ScenarioGenerator(weather, road, vehicle, traffic, emergency, time, location, num_scenarios)
